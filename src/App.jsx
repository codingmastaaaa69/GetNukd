...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-neon-primary selection:text-nuke-black">
      {/* Header / Navbar */}
      <nav className="border-b-2 border-white/10 bg-nuke-black/80 backdrop-blur-md sticky top-0 z-40 px-4 py-3">
